...
namespace MLOps_Dashboard.Controllers
{
    public class DatasetsController : Controller
    {
        ...
        public DatasetsController(MLOpsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Rows,FeaturesCount")] Dataset dataset)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Rows,FeaturesCount")] Dataset dataset)
        {
            if (id != dataset.Id)
            {
                return NotFound();
